                    ...
                    <div className="flex items-center gap-2">
                        {isAuthenticated && (
                            <>
                                ...
                                <button 
                                    onClick={logout}
                                    className="ml-2 px-5 py-2 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition font-semibold shadow-md"
                                >
                                    Đăng xuất
                                </button>
                            </>
                        ...
                        {!isAuthenticated && (
                            <>
                                ...
                                <Link to="/register" className="px-5 py-2 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition font-semibold shadow-md">
                                    Đăng ký
                                </Link>
                            </>
                        )}
